        ...
        {active === "stats" && (
          <div className="admin-tab-panel">
            <div className="admin-stats-grid">
              ...
              <div className="admin-stat-card">
                <span className="admin-stat-label">Cópias de comando (total)</span>
                <span className="admin-stat-value-row">
                  <span className="admin-stat-value">{copiesTotal}</span>
                  <StatDelta value={copiesToday} />
                </span>
              </div>
              <div className="admin-stat-card">
            ...
            <div className="admin-today-panel">
              ...
              <div className="admin-today-grid">
                ...
                <div className="admin-today-card">
                  <span className="admin-today-period">Hoje</span>
                  <span className="admin-today-value">{copiesToday ?? 0}</span>
                  <span className="admin-today-label">Cópias de comando</span>
                  <HourlyChart buckets={copiesTodayHourly} unitLabel="cópias" />
                </div>
                <div className="admin-today-card">
                  <span className="admin-today-period">Semana</span>
                  <span className="admin-today-value">{copiesWeek ?? 0}</span>
                  <span className="admin-today-label">Cópias de comando</span>
                  <HourlyChart buckets={copiesWeekHourly} unitLabel="cópias" />
                </div>
              </div>
            </div>
